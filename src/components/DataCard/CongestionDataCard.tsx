...
const GraphDataCard: React.FC<GraphDataCardprops> =(props:GraphDataCardprops)=> {
  ...
  const handleOkay = () => {
    ...
    history.push('/app-center/DailyCongestion');  // Navigate to the desired path
  };
    ...
    <IonCard  className='congestion-main-container'>
        ...
        <div className="congestion-gauge-container unique-class-to-change-color">
           <div className='gauge-circle'>
            <Gauge width={200} height={150} value={Number(props.newdata.congested_miles)} startAngle={-110} endAngle={110} valueMax={300} innerRadius="75%" outerRadius="100%" 
            ...
            <div className='pti-tti'>
              <div className='pti'>
                  <div className="pti-circle"><CircleIcon style={{fill:'red',fontSize:'13'}}></CircleIcon></div> <div style={{fontSize:16}}>PTI : {props.newdata.pti}</div>
              </div>
              <div className='tti'>
                  <div className="tti-circle"><CircleIcon style={{fill:'red',fontSize:'13'}}></CircleIcon></div> <div style={{fontSize:16}}>TTI : {props.newdata.tti}</div>
              </div>
            </div>
        </div>
