...
import { downloadOutline, downloadSharp, gridOutline, gridSharp, homeOutline, homeSharp, logOut, paperPlaneOutline, bugOutline } from 'ionicons/icons';
import { useLocation, useHistory } from 'react-router';
import { useEffect, useState } from 'react';
import { getLinks } from '../../services/firestoreService';
import { LinkData } from '../../interfaces/LinkData';
import iconService from '../../services/iconService';
import { logout, useAuth } from '../../services/contexts/AuthContext/AuthContext';
                ...
                <IonList>
                    ...
                    {currentUser &&
                        <IonMenuToggle autoHide={false}>
                            ...
                            <IonItem color="medium" routerLink={'/issues'} routerDirection="none" lines="none" detail={false}>
                                <IonIcon slot="start" ios={bugOutline} md={bugOutline} />
