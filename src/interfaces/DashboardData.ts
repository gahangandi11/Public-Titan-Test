...
export class DashboardData {
    ...
    constructor(weeklyCrashes?: DashboardItem,
        ...
        this.crashVal = crashVal ? crashVal : DashboardItem.onError('Error retrieving crash data');
        ...
        this.fatalVal = fatalVal ? fatalVal : DashboardItem.onError('Error retrieving fatality data');
